...
class App {
  ...
  // Immediately use this consturtor first, when page loading.
  constructor() {
    // Get user position
    this._getPosition();
  ...
  _loadMap(position) {
    ...
    // Showhs here we were last steps.
  ...
  _setLocalStorage() {
    localStorage.setItem(`workouts`, JSON.stringify(this.#workouts)); // convert any method to string
  }
